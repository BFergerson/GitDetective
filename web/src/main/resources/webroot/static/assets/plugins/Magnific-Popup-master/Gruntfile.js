 ...
 * *
 * Run 'grunt watch' to automatically regenerate '_site' when you change files in 'src' or in 'webroot'
 * 
 */
...
"pygments: true \r\n";
  ...
  grunt.initConfig({
    ...
    copy: {
      main: {
        files: [
          {expand:true, src: ['dist/**'], dest: 'webroot/'}
        ]
      },
      dev: {
        files: [
    ...
    cssmin: {
      compress: {
        files: {
          "website/site-assets/all.min.css": ["webroot/site-assets/site.css", "webroot/dist/magnific-popup.css"]
        }
      }
    }
