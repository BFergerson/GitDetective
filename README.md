...
The web module contains a Bootstrap website which is generated by the Handlebars template engine and provides a way to view data collected by the indexer(s). The web is deployed as a single instance and is responsible for:
